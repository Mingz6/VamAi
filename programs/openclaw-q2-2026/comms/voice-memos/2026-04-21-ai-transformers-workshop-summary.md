...
- `2026-04-21-ai-transformers-workshop.qta` - original Voice Memo copy
- `2026-04-21-ai-transformers-workshop.m4a` - extracted playable audio
- `2026-04-21-ai-transformers-workshop-whisper.txt` / `.srt` - **PRIMARY**: large-v3-turbo + Silero VAD
- `2026-04-21-ai-transformers-workshop-crosscheck.txt` / `.srt` - medium.en cross-check
- `2026-04-21-ai-transformers-workshop-turbo-no-vad.txt` / `.srt` - first attempt without VAD, kept as a failure reference
